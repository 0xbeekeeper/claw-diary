...
import { getEventsDir, getDateFileName, loadEventsForDate, loadEventsForDays, formatTokens } from './types.js';
...
function generateReportHtml(dateStr, events) {
    ...
    const heatmapCells = hourlyActivity.map((count, hour) => {
...
function generateWeeklyReportHtml(markdown) {
